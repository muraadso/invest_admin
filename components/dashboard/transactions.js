...
const LatestTransactions = () => {
  ...
  return (
    <div
      className='w-full flex-1 py-3 shadow-sm bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg'>
        ...
        <div className="relative flex-1 flex flex-col justify-center items-center">
          {loading ? (
            ...
            <>
              ...
              <p className='mt-2 text-black dark:text-gray-200'>No Transactions Yet!</p>
            </>
          )}
        </div>
      </div>
